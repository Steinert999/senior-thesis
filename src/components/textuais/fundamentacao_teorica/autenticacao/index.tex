...
corresponderem
às credenciais mantidas no banco de dados de serviços de diretório; caso
contrário,
o acesso é negado\cite[p.112]{alnaji2020}.
...
\input{components/textuais/fundamentacao_teorica/autenticacao/estatica}
\input{components/textuais/fundamentacao_teorica/autenticacao/token-senha-unica}
\input{components/textuais/fundamentacao_teorica/autenticacao/desafio-resposta}
\input{components/textuais/fundamentacao_teorica/autenticacao/radiofrequencia}
\input{components/textuais/fundamentacao_teorica/autenticacao/biometrica}