...
Na autenticação de~\acrshortpl{pdf}, há uma lacuna muito grande em relação ao
...
Relacionando o projeto a custos do mesmo, esta pesquisa usa em totalidade
