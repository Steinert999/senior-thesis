...
aplicada" e também por \citeonline{prodanov2013
} que o objetivo da pesquisa aplicada é
...
% Qualitativa
O projeto é definido como qualitativo, pois há
...
\input{components/textuais/metodologia_pesquisa
/quadro_relacional}